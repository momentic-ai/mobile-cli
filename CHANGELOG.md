...
- f658ad3: Reduce iOS interaction delays and allow projects or tests to disable syslog capture to improve simulator responsiveness.

### Patch Changes

- 9cc2cff: Fix selecting Custom path for iOS Add File steps in the mobile editor.
- 3c0f782: Improve mobile AI action self-healing when a cached step targets an element that no longer exists in the app.
- ccb7262: Add an opt-in iOS keyboard settle wait for mobile typing.
